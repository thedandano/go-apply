...
// Truncate returns s truncated to at most limit bytes, with a marker showing
// how many bytes were omitted.
...
func PayloadAttr(key, value string, verbose bool) slog.Attr {
	...
	return slog.String(key, Redact(Truncate(value, payloadLimit)))
}
